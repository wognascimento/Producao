...
$serverUploadPath = "root@192.168.0.49:/var/www/updates/downloads/producao/"
...
$updateJson = @{
    ...
    updateUrl = "http://192.168.0.49/downloads/producao/$zipFileName"
    changelog = @(
        "Ajustes",
        "Melhorias"
    )
...
scp "$projectPath\version.json" "root@192.168.0.49:/var/www/updates/downloads/producao/version.json"
...
Copy-Item -Path "$projectPath\Output\Producao.exe"  -Destination "RedeTemp:"
