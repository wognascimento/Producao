...
{
    /// <summary>
    /// Interação lógica para ViewDetalhesKitDesmontagem.xam
    /// </summary>
    public partial class ViewDetalhesKitDesmontagem : UserControl
    {
        ...
        public ViewDetalhesKitDesmontagem(OsKitSolucaoModel osKit)
        {
            ...
            tbId.Text = "0";
            tbItem.Text = "0";
            tbLocalShopping.Text = "KIT DESMONTAGEM";
            DataContext = new ViewDetalhesKitDesmontagemViewModel();
        }
        ...
        private async void OnPrintClick(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                KitRequisicaoExporter.Exportar("KIT DESMONTAGEM", vm.ChkGerais, caminhoArquivo);
                Application.Current.Dispatcher.Invoke(() => { Mouse.OverrideCursor = null; });
            }
            catch (Exception ex)
            {
    ...
    public class ViewDetalhesKitDesmontagemViewModel : INotifyPropertyChanged
    {
        ...
        public ViewDetalhesKitDesmontagemViewModel()
        {
